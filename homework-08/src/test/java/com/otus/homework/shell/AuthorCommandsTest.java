...
class AuthorCommandsTest {
    ...
    private static final String PATTERN_SUCCEED_DELETE_AUTHOR = "Автор с id '%s' удален";
    ...
    void shouldGetAuthorById() {
        ...
        String result = (String) shell.evaluate(() -> String.format("%s %s", COMMAND_GET_AUTHOR, EXPECTED_AUTHOR_ID));
        assertThat(result).isEqualTo(EXPECTED_AUTHOR.toString());
        verify(service, times(1)).getById(EXPECTED_AUTHOR_ID);

        result = (String) shell.evaluate(() -> String.format("%s %s", COMMAND_GET_AUTHOR_SHORT, EXPECTED_AUTHOR_ID));
        assertThat(result).isEqualTo(EXPECTED_AUTHOR.toString());
    ...
    void shouldDeleteAuthorById() {
        ...
        String result = (String) shell.evaluate(() -> String.format("%s %s", COMMAND_DELETE_AUTHOR, EXPECTED_AUTHOR_ID));
        ...
        result = (String) shell.evaluate(() -> String.format("%s %s", COMMAND_DELETE_AUTHOR_SHORT, EXPECTED_AUTHOR_ID));
        assertThat(result).isEqualTo(String.format(PATTERN_SUCCEED_DELETE_AUTHOR, EXPECTED_AUTHOR_ID));
