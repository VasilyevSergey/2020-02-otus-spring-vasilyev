...
class BookServiceImplTest {
    ...
    @Test
    void shouldCountFallback() {
        assertThat(bookService.countFallback()).isEqualTo(0L);
    }

    @Test
    void shouldGetDefaultAuthorList() {
        assertThat(bookService.getDefaultBookList()).isEqualTo(Collections.emptyList());
    }

    @Test
    void shouldGetByAuthorIdFallback() {
        assertThat(bookService.getByAuthorIdFallback(TEST_AUTHOR_ID)).isEqualTo(Collections.emptyList());
    }
}
